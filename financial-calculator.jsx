...
import { Calculator, Home, Car, DollarSign, TrendingUp, Shield, X, Save, FolderOpen, GitCompare, PiggyBank } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Financial Calculator Suite</h1>
              <p className="text-gray-600">Smart tools for budgeting, loans, and debt management</p>
              {currentScenario && (
                <p className="text-sm text-indigo-600 mt-2">
                  📊 Active Scenario: <span className="font-semibold">{currentScenario.name}</span>
                </p>
              )}
            </div>
          ...
          <div className="p-6">
            ...
            {activeTab === 'savings' && (
              <div className="space-y-6">
                ...
                <p className="text-gray-600">Compare savings accounts, CDs, and investment returns with compound interest</p>
