  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-sm text-slate-600 max-w-2xl">
        ...
        rental or commercial property is worth the risk. No judgment, just
        numbers.
      </p>
      ...
      <div className="grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm border border-slate-100 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <h3 className="text-lg font-semibold text-slate-900 mb-3">
              Property &amp; one-time costs
            </h3>
            <p className="text-xs text-slate-500 mb-3">
              Purchase price + closing + rehab = your total cash in on day one.
            </p>
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm border border-slate-100 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            ...
            <p className="text-xs text-slate-500 mb-3">
              Use realistic rent and vacancy. Over-optimistic assumptions will
              make every deal look good on paper.
            </p>
            <div className="grid gap-4 md:grid-cols-3">
              <RoiField
                label="Monthly rent"
          ...
          <div className="rounded-2xl bg-white p-5 shadow-sm border border-slate-100 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            ...
            <p className="text-xs text-slate-500 mb-3">
              OpEx includes repairs, management, utilities you cover, etc.
              Down payment, rate, and term define your loan.
            </p>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl bg-slate-900 p-4 text-sm text-slate-100 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
...
function RoiMetricTile({ label, value, emphasize }) {
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
        <div className="space-y-4">
          ...
          <div className="rounded-xl bg-white border border-slate-200 p-4 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <label className="text-sm text-slate-700">
              ...
              <p className="mt-1 text-[11px] text-slate-500">
                Use your take-home (after taxes) if you want a realistic view,
                or gross if you&apos;re mapping against % rules.
              </p>
            </label>
          </div>

          <div className="rounded-xl bg-white border border-slate-200 p-4 space-y-3 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            ...
            <p className="text-[11px] text-slate-500">
              Tag each expense as a need, want, or savings move. This is where
              the 50/30/20 picture comes from.
            </p>
            <div className="space-y-2">
              {expenses.map((e, i) => (
                <div
                  key={i}
                  className="flex flex-col sm:flex-row gap-2 items-start sm:items-center text-xs md:text-sm"
                >
                  <input
                    className="flex-1 px-2 py-2 border border-slate-300 rounded-lg w-full"
                  ...
                  <div className="flex gap-2 w-full sm:w-auto">
                    ...
                    {expenses.length > 1 && (
                      <button
                        ...
                        className="text-rose-500 hover:text-rose-700 mt-1 sm:mt-0"
                      >
                        <X size={16} />
                      </button>
                    )}
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl bg-gradient-to-br from-slate-900 to-slate-800 text-slate-100 p-4 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
          ...
          {totalIncome > 0 && (
            <div className="rounded-xl bg-white border border-slate-200 p-4 space-y-4 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
...
function BarChartLike({ data }) {
  ...
  return (
    <AreaChart data={transformed} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="rounded-xl bg-white border border-slate-200 p-4 space-y-3 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <div className="grid gap-3">
              <label className="text-sm text-slate-700">
                ...
                <input
                  type="number"
                  className="mt-1 w-full px-3 py-2.5 border border-slate-300 rounded-lg"
                  value={price}
              ...
              <label className="text-sm text-slate-700">
                ...
                />
                <p className="mt-1 text-[11px] text-slate-500">
                  Use what actually lands in your bank account after taxes and
                  deductions.
                </p>
              </label>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl bg-white border border-slate-200 p-4 text-sm space-y-2 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
          ...
          <div className="bg-slate-900 text-slate-100 rounded-xl p-4 text-xs space-y-2 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <label className="text-sm text-slate-700">
              Home price
              <input
                type="number"
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className="text-sm text-slate-700">
                ...
                />
                <p className="mt-1 text-[11px] text-slate-500">
                  Before taxes and deductions. This is what lenders care about
                  for approval.
                </p>
              </label>
              <label className="text-sm text-slate-700">
                ...
                />
                <p className="mt-1 text-[11px] text-slate-500">
                  After taxes, benefits, and withholdings. This is what you
                  actually live on.
                </p>
              </label>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 text-sm space-y-2 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <h3 className="font-semibold text-slate-900 mb-1">
              Payment breakdown
            </h3>
            <div className="flex justify-between">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 text-sm space-y-2 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            ...
            <p className="mt-2 text-[11px] text-slate-500">
              You can be &quot;approved&quot; and still feel house-poor. Use
              both numbers to draw your own line.
            </p>
          </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <div className="flex justify-between items-center">
              <TermTooltipLabel
                term={method === 'avalanche' ? 'avalanche' : 'snowball'}
            ...
            <p className="text-[11px] text-slate-500">
              List each balance with its interest rate and minimum payment.
              Extra money goes toward either the highest rate (avalanche) or
            ...
            <div className="grid grid-cols-2 gap-3 pt-2 border-t border-slate-100 mt-3">
              <label className="text-xs md:text-sm text-slate-700">
                ...
                <input
                  type="number"
                  className="mt-1 w-full px-2 py-2.5 border border-slate-300 rounded-lg"
                  value={extra}
              ...
              <label className="text-xs md:text-sm text-slate-700">
                Strategy
                <select
                  className="mt-1 w-full px-2 py-2.5 border border-slate-300 rounded-lg text-sm"
                  value={method}
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-3 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <label className="text-sm text-slate-700">
                ...
                />
                <p className="mt-1 text-[11px] text-slate-500">
                  Long-term stock market averages ~7–10% before inflation. Be
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 transition hover:shadow-md hover:-translate-y-0.5 duration-150">
            <div className="h-48">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" vertical={false} />
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 bg-emerald-50 text-emerald-700 rounded-full text-xs font-medium hover:bg-emerald-100 border border-emerald-100"
                >
                  <Shield size={14} />
